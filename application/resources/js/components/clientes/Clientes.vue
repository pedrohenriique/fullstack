                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <input class="form-control" v-model="form.telefone" v-mascara:telefone onblur="valida_telefone_vazio(this,1)"
            ...
            <template slot="conteudo">
                ...
                <div class="alert alert-danger alert-dismissible" v-if="!preload">
                    <h6 class="text-center"><i class="icon fa fa-times"></i> Você deseja realmente excluir este
                        Cliente?
                        (obs: Todos os pedidos deste cliente também serão excluídos ).</h6>
                </div>
            </template>
            <template slot="rodape">
...
export default {
    ...
    data() {
        return {
            ...
            urlPaginacao: `${URL_ADMIN}/cliente/atualizar`,
            controle: {
                carregando: false,
                dados: {
                    campoBusca: '',
    ...
    methods: {
        ...
        cadastrar() {
            ...
            this.preload = true;
            axios.post(`${URL_ADMIN}/cliente/`, this.form)
                .then(response => {
        ...
        formAlterar(cliente) {
            ...
            axios.get(`${URL_ADMIN}/cliente/${cliente}/edit`)
                .then(response => {
        ...
        deleteformDeletar() {
            ...
            axios.delete(`${URL_ADMIN}/cliente/${this.form.id}`).then(response => {
        ...
        alterarformClientes() {
            ...
            axios.put(`${URL_ADMIN}/cliente/${this.form.id}`, this.form).then(response => {
                $('#janelaForm').modal('hide');
                if (response.status === 201) {
